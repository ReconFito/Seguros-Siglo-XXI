    ...
    public partial class Plantilla : System.Web.UI.MasterPage
    {
        ...
        public void CargaBienvenida()
        {
            var fecha = Convert.ToDateTime(
                usuario.BuscarUsuario(Session["email"].ToString())[1]).ToString("MM/dd/yyyy");
        ...
        public void Opciones()
        {
            if (Session["estadoSesion"] != null)
            {
                ...
                {
                    var btnRegistar = this.contentBody.FindControl("btnRegistrar") as HtmlGenericControl;
