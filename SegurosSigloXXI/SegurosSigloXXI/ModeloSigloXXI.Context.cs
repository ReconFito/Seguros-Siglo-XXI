...
namespace SegurosSigloXXI
{
    ...
    public partial class polizassigloxxiEntities : DbContext
    {
        ...
        public virtual int paRegistroPolizaUpdate(Nullable<int> pID, Nullable<int> pID_COBERTURA_POLIZA, Nullable<decimal> pMONTO_ASEGURADO, Nullable<decimal> pPORCENTAJE_COBERTURA, Nullable<decimal> monto_adicciones, Nullable<decimal> pPRIMA_ANTES_IMPUESTOS, Nullable<decimal> pIMPUESTOS, Nullable<decimal> pPRIMA_FINAL)
        {
            var pIDParameter = pID.HasValue ?
                new ObjectParameter("PID", pID) :
                new ObjectParameter("PID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paRegistroPolizaUpdate", pIDParameter, pID_COBERTURA_POLIZAParameter, pMONTO_ASEGURADOParameter, pPORCENTAJE_COBERTURAParameter, monto_adiccionesParameter, pPRIMA_ANTES_IMPUESTOSParameter, pIMPUESTOSParameter, pPRIMA_FINALParameter);
        }
